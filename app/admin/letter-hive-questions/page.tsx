              ...
              <div className="bg-[#cc994b] p-6 rounded-3xl shadow-lg shadow-[#cc994b]/20 text-white">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                  <input
                    ...
                    className="flex-[2] p-3 rounded-xl text-gray-800 focus:ring-2 focus:ring-white outline-none"
                  />
                  <input
                    type="text"
                    value={newAnswer}
                    ...
                    placeholder="الإجابة"
                    className="flex-1 p-3 rounded-xl text-gray-800 focus:ring-2 focus:ring-white outline-none"
                  />
                  <button 
                    onClick={addQuestion}
